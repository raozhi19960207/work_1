...
/**
 * Created by raozhi on 2017/5/16.
 */
...
public class TraceAspect
{
    ...
    //定义切入点，截获所有方法的执行
    private static final String POINT_METHOD = "execution(* com.yaoyumeng.v2ex..*.*(..))";
    private static final String POINT_CALLMETHOD = "call(* com.yaoyumeng.v2ex..*.*(..))";
